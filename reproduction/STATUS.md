...
| A09 | ANI-1x / QBC | 分子势能面覆盖 AL | 已收录 | 锁定论文时代完整 AL 入口；先用现代 TorchANI 做 COMP6 小子集评估 |
...
截至 2026-08-03，仓库已经为 33 个正式收录或完成准入核验的论文/项目建立
独立 recipe：

- A01–A09：9 个正式材料主动学习条目；
- W01–W07：7 个已核验观察条目；
- P01–P10 中已收录的 10 个 AL、BO、平台与并发学习条目；
- AD01、PS01、H01、L01：4 个应用或混合闭环条目；
- S01–S03：3 个物理/普通机器学习支持条目。

另有 7 篇 2026 观察论文因代码、数据、许可证或任务对应尚未核实，逐项记录在
